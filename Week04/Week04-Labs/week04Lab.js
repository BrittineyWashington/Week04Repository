 ...
 * ↓ YOUR CODE HERE ↓ */
//Step 1: 
const eating = "sandwiches";
const drinking = "water."; 

//Step 2: 
let myName = ("Brittiney " + "Washington");
let friendName = ("Gabrielle " + "Goode");


//Question: Name a reason why you would use const instead of let.
//Answer: One would use const instead of let when they want to make sure a variable stays the same and can't be changed on purpose or accidnetally by another coder. Const stays the same where let is just used for a block of code within a scope. 
 ...
 * ↓ YOUR CODE HERE ↓ */
//step 1: 
console.log(`${friendName} and ${myName} went to lunch yesterday, we both had ${eating} and ${drinking}`);
...
//step 2: 
//fixed the code by changing "juice." into "water." 


//Question: Read the error message - in your own words - what does it mean?
//Answer: Identifier 'drinking' has already been declared. 
//because we declared drinking as a const variable it cannot be reassigned or redeclared, it will throw an error if try to do this. 
...
//step 2: 
// {`${friendName} and ${myName} went to lunch yesterday, we both had ${lunchTime}`};
// return `${friendName} and ${myName} went to lunch yesterday, we both had`


// console.log(lunchTime('Pizza', 'Water')) 

//`${friendName} and ${myName} went to lunch yesterday, we both had ${eating} and ${drinking}`
